...
def get_labels(type):
    ...
    if type == "carla":
        ...
        labels = [
            #      name         id    color
            Label("unlabaled"    ,0  ,(0,0,0)),
            Label("building"     ,1  ,(70,70,70)),
            Label("fence"        ,2  ,(100,40,40)),
            Label("other"        ,3  ,(55,90,80)),
            Label("pedestian"    ,4  ,(220,20,60)),
            Label("pole"         ,5  ,(153,153,153)),
            Label("roadline"     ,6  ,(157,234,50)),
            Label("road"         ,7  ,(128,64,128)),
            Label("sidewalk"     ,8  ,(244,35,232)),
            Label("vegetation"   ,9  ,(107,142,35)),
            Label("vehicle"      ,10 ,(0,0,142)),
            Label("wall"         ,11 ,(102, 102, 156)),
            Label("traffic sign" ,12 ,(220,220,0)),
            Label("sky"          ,13 ,(70,130,180)),
            Label("ground"       ,14 ,(81,0,81)),
            Label("bridge"       ,15 ,(150,100,100)),
            Label("rail track"   ,16 ,(230,150,140)),
            Label("guard rail"   ,17 ,(180, 165, 180)),
            Label("traffic light",18 ,(250,170,30)),
            Label("static"       ,19 ,(110,190,160)),
            Label("dynamic"      ,20 ,(170,120,50)),
            Label("water"        ,21 ,(45,60,150)),
            Label("terrain"      ,22 ,(145,170,100))
        ]
        return labels


def loadImages(x_path, y_path, images_scale = 1/2, number_of_images = 200, skip_images = 0, x_dtype = "float16", y_dtype=np.bool_, parallel =True, threads = 12, flip=False, data_from = "cityscapes", category2names = {0:["vehicle"], 1:["road", "roadline"]}):   
    labels = get_labels(data_from)
    ...
    #category2names = {0:["car", "truck", "bus"], 1:["road"]}
    #category2names = {0:["vehicle"], 1:["road", "roadline"]}
    category2ids = []
...
def labels2RGB(images, Tags2color = {0:(0,0,142), 1:(128, 64, 128), 2:(0,0,0)} ,avarage = False):
